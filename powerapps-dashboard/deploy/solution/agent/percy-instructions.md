# Percy — agent Overview Instructions (clone for the solution build)

> 🟩 **PROVIDED — paste verbatim.** This mirrors
> [`../../copilot-studio/percy-instructions.md`](../../copilot-studio/percy-instructions.md); it's
> cloned here so the solution kit is self-contained. 🟦 **MANUAL ACTION:** paste this into the Percy
> agent's **Overview → Instructions**, then append the nine programme rules from
> [`PERCY_BUILD_PACK.md` §9](../../../formulas/percy/backend/PERCY_BUILD_PACK.md#9-programme-rules-canonical)
> where indicated.
